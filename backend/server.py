...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://ai-travel-planner-4.preview.emergentagent.com"],
...
async def chat_endpoint(request: ChatRequest):
    try:
        ...
        # Only add contextual questions if no ui_actions were generated by conversation manager
        if not result.get("ui_actions"):
